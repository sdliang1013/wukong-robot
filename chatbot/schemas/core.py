...
from chatbot.robot import utils
...
class Paginate:
    ...
    def serialize(self) -> dict:
        return {"page": self.page, "paginate_by": self.paginate_by,
                "total": self.total, "total_page": self.total_page}
...
class Page:
    ...
    def serialize(self) -> dict:
        return {"paginate": self.paginate.serialize(),
...
class Response:
    ...
    def serialize(self) -> dict:
        return {"code": self.code, "message": self.message, "data": serialize(self.data)}

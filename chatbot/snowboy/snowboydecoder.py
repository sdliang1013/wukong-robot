...
from chatbot import resource_file
from chatbot.robot import constants, log
from chatbot.robot import utils
from chatbot.snowboy import snowboydetect
    ...
    def listen(
        ...
        while self.is_listening():
            ...
            if stop_recording == True:
                voice_file = self.saveMessage(voice_data=self.recordedData,

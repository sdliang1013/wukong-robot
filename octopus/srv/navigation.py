...
class OfficeService:
    ...
    def __init__(self, file: str):
        self.office_list = TxtEntity(
            cols=["name", "color"], file=constants.getConfigData(file)
        )
...
class DoctorService:
    def __init__(self, file: str):
        self.doctor_list = TxtEntity(
            split=" ", cols=["py", "name"], file=constants.getConfigData(file)
        )
